...
SECRET_KEY = 'django-insecure-%t@^-r6qhg*8g=)99^4wmk$c-zuj-2r(&pz2v41j=0_^jb))zo'
...
LOGIN_URL = '/login/'  # or '/cashier_login/' depending on which login page you have
