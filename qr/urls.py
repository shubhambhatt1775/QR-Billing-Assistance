...
from qrcus.views import index,register,user_login,logout,view_bill,update_bill_status,admin_dashboard,manage_products,add_product,edit_product,delete_product,payment_status,manage_users,sales_report,preset_billing,cashier_dashboard,create_bill,cashier_preset_items,cashier_payment,cashier_login,cashier_logout,customer_bill,customer_payment,customer_profile,customer_logout,scan_qr,view_current_bill,pay_now,admin_logout,razorpayment,payment_success,view_invoice
...
urlpatterns = [
    ...
    # path('view_digital_bill/',view_digital_bill, name='view_digital_bill'),
